...
- Scientific Council with grounded specialist reviewers, a Skeptic and Chair.
- API-budget controls for the Council: role-specific token ceilings, compact evidence, usage accounting, cache and cooldown.
...
## MEMÓRIA v2.0 — Tectonic Intelligence

v2.0 adds an experimental tectonic-intelligence layer without changing the scientific boundary of the project. It includes multi-method anomaly detection, Gutenberg–Richter b-value monitoring, migration analysis, recurrent seismic regimes, an ETAS-lite benchmark, optional GNSS/InSAR/fault context, evidence graphs and a Mistral-powered Scientific Council.

**Important:** MEMÓRIA detects statistical changes in observed seismic behaviour. It does not predict the date, location or magnitude of future earthquakes and is not an official IPMA product or alerting service.

See `docs/v2_tectonic_intelligence.md` and `docs/v2_test_guide.md`.
